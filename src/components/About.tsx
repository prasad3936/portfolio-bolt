          ...
          <div className="mb-16">
            <div className="bg-zinc-800 rounded-lg p-8 border border-zinc-700">
              <p className="text-lg text-gray-300 leading-relaxed text-center">
                👋 Hi, I’m Prasad A Self Taught Cloud × DevOps Engineer I code,
                I write YAMLs, and I love turning ideas into reality. From
                designing infrastructure to deploying applications, I bring
                concepts to life using AWS, Kubernetes, Docker, GitHub Actions,
                and ArgoCD. I document the journey along the way — sharing what
                I learn through blogs on Medium so others in the DevOps and
                cloud community can benefit too. When I’m not working with tech,
                you’ll probably find me, 📚 Reading books on mythology & history
                🏍️ Riding through countryside roads 🌱 Spending time on my farm
              </p>
            </div>
          </div>
