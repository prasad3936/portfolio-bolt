...
const Blog = () => {
  const blogPosts = [
    {
      title:
        "Building a Geolocation Failover Based Scalable Web Architecture on AWS",
      excerpt:
        "A deep dive into building resilient, multi-region AWS architectures using Route 53, health checks, and autoscaling.",
    ...
    {
      title:
        "Setting Up Docker and Gitea on Ubuntu Server: A Comprehensive Guide",
      excerpt:
        "Complete walkthrough of installing and configuring Docker and Gitea on Ubuntu Server for self-hosted Git repository management.",
    ...
    {
      title:
        "CI/CD with GitHub Actions and Self-Hosted Runner to Deploy a Static Site on Minikube",
      excerpt:
        "Learn how to set up a complete CI/CD pipeline using GitHub Actions with self-hosted runners to deploy static sites on Minikube.",
    ...
    {
      title:
        "From Dev To Delivery : How I Used AI to Build and GitHub Actions To Ship a Full Desktop App",
      excerpt: "Learn how to use AI for faster and effective development",
    ...
    {
      title:
        "🚀 Three-Tier Application Deployment on Kind Cluster Backed by GitHub Actions and ArgoCD",
      excerpt:
        "Learn how work to work with k8s and ArgoCD use for faster and effective development",
      url: "https://medium.com/@prasadcpatil246/three-tier-application-deployment-on-kind-cluster-backed-by-github-actions-and-argocd-fa377ae37c6a",
      date: "Published on Medium",
      readTime: "7 min read",
      featured: false,
    },
